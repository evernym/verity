...
trait GetMsgsBaseMsg extends LegacyMsgBase with HasMsgType with ActorMessage {
...
case class GetMsgsReqMsg(excludePayload: Option[String],
                         uids: Option[List[String]] = None,
                         statusCodes: Option[List[String]] = None) extends LegacyMsgBase with ActorMessage

case class GetMsgsRespMsg_MFV_0_5(`@type`: TypeDetail, msgs: List[MsgDetail]) extends LegacyMsgBase

case class GetMsgsRespMsg_MFV_0_6(`@type`: String, msgs: List[MsgDetail]) extends LegacyMsgBase
