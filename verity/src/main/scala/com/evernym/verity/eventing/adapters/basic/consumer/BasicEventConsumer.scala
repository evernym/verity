package com.evernym.verity.eventing.adapters.basic.consumer
...
import com.evernym.verity.eventing.adapters.basic.{BaseEventAdapter, HttpServerParam}
import com.evernym.verity.eventing.adapters.basic.event_store.SubscribeTopic
...
class BasicConsumerAdapter(val appConfig: AppConfig,
  ...
  override def start(): Future[Done] = {
    val topicNames = appConfig.getStringListReq("verity.eventing.basic-source.topics")
  ...
  private val subscriberId: String = appConfig.getStringReq("verity.eventing.basic-source.id")
  private val listenerParam: HttpServerParam = {
    HttpServerParam(
      appConfig.getStringReq("verity.eventing.basic-source.http-listener.host"),
      appConfig.getIntReq("verity.eventing.basic-source.http-listener.port")
    )
  }
