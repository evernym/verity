...
import com.evernym.verity.event_bus.ports.consumer.EventHandler
...
abstract class KafkaSpecBase(kafkaPort: Int)
  ...
  def createProducerSettings(config: Config): ProducerSettings[String,String] = {
  ...
  def createConsumer(eventHandler: EventHandler,
