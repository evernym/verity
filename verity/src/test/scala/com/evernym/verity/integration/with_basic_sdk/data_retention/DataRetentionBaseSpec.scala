...
trait DataRetentionBaseSpec { this: VerityProviderBaseSpec =>
  ...
  val vdrTools = new MockVdrTools(MockLedgerRegistryBuilder(Map(INDY_SOVRIN_NAMESPACE -> MockIndyLedger("genesis.txn file path", None))).build())(futureExecutionContext)
