...
object Constants {
  ...
  val AGENCY_IDENTITY_CACHE_FETCHER_ID = 2
  val WALLET_VER_KEY_CACHE_FETCHER_ID = 3
  val AGENT_ACTOR_CONFIG_CACHE_FETCHER_ID = 4
  val ROUTING_DETAIL_CACHE_FETCHER_ID = 5
  val LEDGER_GET_ENDPOINT_CACHE_FETCHER_ID = 6
  val LEDGER_GET_VER_KEY_CACHE_FETCHER_ID = 7
  val LEDGER_GET_SCHEMA_FETCHER_ID = 8
  val LEDGER_GET_CRED_DEF_FETCHER_ID = 9
