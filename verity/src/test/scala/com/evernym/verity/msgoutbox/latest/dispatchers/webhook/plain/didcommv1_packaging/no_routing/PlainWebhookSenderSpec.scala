package com.evernym.verity.msgoutbox.latest.dispatchers.webhook.plain.didcommv1_packaging.no_routing
...
class PlainWebhookSenderSpec
  ...
  lazy val outboxIdParam = OutboxIdParam("relDID-recipId-default")
