package com.evernym.verity.protocol.protocols.questionAnswer.v_1_0.expire_after_terminal_state
...
class QuestionAnswerSpec
  ...
  override val defaultInitParams = Map(
    DATA_RETENTION_POLICY -> """{"expire-after-days":"30 day","expire-after-terminal-state":true}"""
  )
