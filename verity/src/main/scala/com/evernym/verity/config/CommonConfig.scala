...
trait CommonConfig {
  ...
  val AAS_CLEANUP_MANAGER_SCHEDULED_JOB_INITIAL_DELAY_IN_SECONDS =
    s"$AAS_CLEANUP_MANAGER_SCHEDULED_JOB.initial-delay-in-seconds"
  ...
  val AAS_CLEANUP_EXECUTOR_SCHEDULED_JOB_INITIAL_DELAY_IN_SECONDS =
    s"$AAS_CLEANUP_EXECUTOR_SCHEDULED_JOB.initial-delay-in-seconds"
  ...
  val MIGRATE_THREAD_CONTEXTS_SCHEDULED_JOB_INITIAL_DELAY_IN_SECONDS =
    s"$MIGRATE_THREAD_CONTEXTS_SCHEDULED_JOB.initial-delay-in-seconds"
