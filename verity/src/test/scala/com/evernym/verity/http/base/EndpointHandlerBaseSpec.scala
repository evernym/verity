...
import com.evernym.verity.http.base.restricted.{AgencySetupSpec, AgentConfigsSpec, AppStatusHealthCheckSpec, MockApiHealthCheck, RestrictedRestApiSpec}
...
import com.evernym.verity.http.route_handlers.restricted.AbstractApiHealthCheck
...
trait EdgeEndpointBaseSpec
  ...
  override val apiHealthCheck: AbstractApiHealthCheck = mock[MockApiHealthCheck]
}
