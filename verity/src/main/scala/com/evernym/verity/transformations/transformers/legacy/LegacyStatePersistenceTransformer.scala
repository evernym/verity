...
import com.evernym.verity.actor.DeprecatedStateMsg
...
class LegacyStatePersistenceTransformer(transformationId: Int)
  extends (TransParam[Array[Byte]] <=> DeprecatedStateMsg) {

  override val execute: TransParam[Array[Byte]] => DeprecatedStateMsg = { param =>
    DeprecatedStateMsg(transformationId, param.codeReq, ByteString.copyFrom(param.msg))
  }

  override val undo: DeprecatedStateMsg => TransParam[Array[Byte]] = { param =>
