...
import com.evernym.verity.actor.protocols.{BaseProtocolActorSpec, MockControllerActorBase, SendControlMsg}
import com.evernym.verity.actor.testkit.CommonSpecUtil
import com.evernym.verity.config.AppConfig
import com.evernym.verity.constants.ActorNameConstants.ACTOR_TYPE_USER_AGENT_ACTOR
import com.evernym.verity.protocol.actor.{ExtractEventsActor, ExtractedEvent, ExtractionComplete}
  ...
  extends BaseProtocolActorSpec {
    ...
    "ExtractEventsActor" - {
      ...
      "empty event stream should return ExtractionComplete imminently" in {
        ...
        expectMsgType[ExtractionComplete]
      }
