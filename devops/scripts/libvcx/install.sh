...
then
  ...
  sudo apt-get install -y --allow-downgrades libindy=1.15.0~1542-xenial libnullpay=1.15.0~1542-xenial libvcx=0.9.2-xenial~754
else
  ...
  sudo apt-get install -y --allow-downgrades libindy=1.15.0~1542-bionic libnullpay=1.15.0~1542-bionic libvcx=0.9.2-bionic~754
fi
