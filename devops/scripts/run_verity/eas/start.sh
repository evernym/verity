...
export VERITY_KAMON_PROMETHEUS_PORT=$((EAS_KAMON_PROMETHEUS_PORT_BASE+CUR_NODE_NUMBER))
export VERITY_BASIC_EVENT_STORE_PORT=$((EAS_BASIC_EVENT_STORE_PORT_BASE+CUR_NODE_NUMBER))
export VERITY_BASIC_CONSUMER_PORT=$((EAS_BASIC_EVENT_CONSUMER_PORT_BASE+CUR_NODE_NUMBER))
...
startCmd="/usr/bin/java -javaagent:$SCRIPT_DIR/../../../../integration-tests/lib/kanela-agent.jar -cp $VERITY_JAR_LOCATION:$SCRIPT_DIR/../../../../verity/src/main/resources:$SCRIPT_DIR/../../../../integration-tests/src/test/resources/common:$SCRIPT_DIR/../../../../integration-tests/src/test/resources/enterprise com.evernym.verity.Main"
