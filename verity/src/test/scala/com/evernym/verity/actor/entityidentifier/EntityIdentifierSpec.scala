...
class EntityIdentifierSpec extends AnyFreeSpec with Matchers{
  ...
  "EntityIdentifier object" - {
    "should parse path correctly" in {
      ...
      parsePath(ActorPath.fromString("akka://verity/system/sharding/AgencyAgent/59/30629617-1d2a-43b1-afb3-dfe5389d7e01/amp-4f1cb237-8355-4ccf-9907-ce37bf6c6c81")) shouldBe
        EntityIdentity("amp-4f1cb237-8355-4ccf-9907-ce37bf6c6c81", "AgencyAgentChild", Some(59), false, false, false)
      parsePath(ActorPath.fromString("akka://verity/system/sharding/UserAgent/54/a06c8ec9-368b-4fa5-ab37-b6fdd7caffae/amp-f0882cf9-022f-4bb7-ab64-d31b9c3b0f5e")) shouldBe
        EntityIdentity("amp-f0882cf9-022f-4bb7-ab64-d31b9c3b0f5e", "UserAgentChild", Some(54), false, false, false)
      parsePath(ActorPath.fromString("akka://verity/system/sharding/AgencyAgent/53/d37d361f-8986-4108-bf2d-dad9dfa0bdc3")) shouldBe
        EntityIdentity("d37d361f-8986-4108-bf2d-dad9dfa0bdc3", "AgencyAgent", Some(53), false, false, false)
