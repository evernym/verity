...
then
  ...
  sudo apt-get install -y --allow-downgrades libindy=1.15.0~1560-xenial libnullpay=1.15.0~1560-xenial libvcx=0.10.0-xenial~1066
else
  ...
  sudo apt-get install -y --allow-downgrades libindy=1.15.0~1560-bionic libnullpay=1.15.0~1560-bionic libvcx=0.10.0-bionic~1066
fi
