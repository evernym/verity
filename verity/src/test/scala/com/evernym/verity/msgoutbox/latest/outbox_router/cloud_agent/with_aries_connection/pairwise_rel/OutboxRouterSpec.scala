package com.evernym.verity.msgoutbox.latest.outbox_router.cloud_agent.with_aries_connection.pairwise_rel
...
import com.evernym.verity.msgoutbox.latest.outbox_router.cloud_agent.with_aries_connection.{CloudAgentOutboxRouterBaseSpec, VerityCloudAgent}
