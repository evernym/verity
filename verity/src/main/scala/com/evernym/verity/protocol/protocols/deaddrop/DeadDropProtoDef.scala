...
object DeadDropProtoDef
  ...
  override def create(
                       context: ProtocolContextApi[DeadDropProtocol, Role, DeadDropProtoMsg, DeadDropEvt, DeadDropState, String],
                       executionContext: ExecutionContext
                     ): Protocol[DeadDropProtocol, Role, DeadDropProtoMsg, DeadDropEvt, DeadDropState, String] = { // TODO can this be generically implemented in the base class?
    new DeadDropProtocol(context)
  }
