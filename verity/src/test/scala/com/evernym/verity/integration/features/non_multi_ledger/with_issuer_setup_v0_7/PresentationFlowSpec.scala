...
import com.evernym.verity.protocol.protocols.issuersetup.v_0_7.PublicIdentifier
  ...
  "IssuerSDK" - {
    "sends 'offer' (issue-credential 1.0) message" - {
      "should be successful" in {
        ...
        checkOfferSentForFQIdentifiers(receivedMsg.msg)
  ...
  "IssuerSDK" - {
    ...
    "when sent 'issue' (issue-credential 1.0) message" - {
      "should be successful" in {
        ...
        val receivedMsg = issuerSDK.expectMsgOnWebhook[Sent]()
        checkCredSentForFQIdentifiers(receivedMsg.msg)
