...
object TicTacToeProtoDef extends ProtocolDefinition[TicTacToe, Role, Any, Any, State, String] {
  ...
  def create(ctx: ProtocolContextApi[TicTacToe, Role, Any, Any, State, String], mw: MetricsWriter): TicTacToe = { //TODO can this be generically implemented in the base class?
    new TicTacToe(ctx)
  }
