...
import com.evernym.verity.metrics.{MetricsWriter, MetricsWriterExtension, MetricsWriterExtensionImpl}
...
class HttpRouteHandler(val platform: Platform)
  ...
  override val metricsWriter: MetricsWriterExtensionImpl = MetricsWriterExtension(system)
}
