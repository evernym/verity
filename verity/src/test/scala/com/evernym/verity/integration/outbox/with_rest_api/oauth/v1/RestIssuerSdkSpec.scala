...
import com.evernym.verity.integration.base.sdk_provider.{HolderSdk, IssuerRestSDK, SdkProvider, V1OAuthParam}
...
class RestIssuerSdkSpec
  ...
  lazy val issuerRestSDKFut = setupIssuerRestSdkAsync(issuerVerityEnv, executionContext, Option(V1OAuthParam(5.seconds)))
