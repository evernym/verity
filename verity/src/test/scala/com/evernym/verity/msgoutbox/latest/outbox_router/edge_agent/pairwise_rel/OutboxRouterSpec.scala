package com.evernym.verity.msgoutbox.latest.outbox_router.edge_agent.pairwise_rel
...
import com.evernym.verity.msgoutbox.latest.outbox_router.edge_agent.{EdgeAgentOutboxRouterBaseSpec, VerityEdgeAgent}
