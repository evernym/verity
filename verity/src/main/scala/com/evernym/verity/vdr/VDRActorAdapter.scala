...
import com.evernym.verity.vdr.service.{CreateVDR, VDRActor, VDRToolsConfig}

import java.util.concurrent.TimeUnit
import scala.concurrent.ExecutionContext

//creates and interacts with VDRActor
class VDRActorAdapter(vdrCreator: CreateVDR,
  ...
  val vdrActorRef: ActorRef[VDRActor.Cmd] = system.spawnAnonymous(VDRActor(vdrCreator, vdrToolsConfig, ec))
