...
export VERITY_KAMON_PROMETHEUS_PORT=$((CAS_KAMON_PROMETHEUS_PORT_BASE+CUR_NODE_NUMBER))
export VERITY_BASIC_EVENT_STORE_PORT=$((CAS_BASIC_EVENT_STORE_PORT_BASE+CUR_NODE_NUMBER))
export VERITY_BASIC_CONSUMER_PORT=$((CAS_BASIC_EVENT_CONSUMER_PORT_BASE+CUR_NODE_NUMBER))
