...
object ConfigConstants {
  ...
  val EVENT_CONSUMER = s"$VERITY.event-consumer"
  val EVENT_CONSUMER_BUILDER_CLASS = s"$EVENT_CONSUMER.builder-class"

  val EVENT_PRODUCER = s"$VERITY.event-producer"
  val EVENT_PRODUCER_BUILDER_CLASS = s"$EVENT_PRODUCER.builder-class"
