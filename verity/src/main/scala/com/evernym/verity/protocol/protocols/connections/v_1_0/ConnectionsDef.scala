...
import com.evernym.verity.protocol.engine.{AccessRight, AccessSign, AccessStoreTheirDiD, AccessVerKey, AccessVerify, MsgFamily, ParameterName, Parameters, ProtocolContextApi, ProtocolDefinition, Scope}
