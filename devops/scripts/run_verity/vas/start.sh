...
export VERITY_KAMON_PROMETHEUS_PORT=$((VAS_KAMON_PROMETHEUS_PORT_BASE+CUR_NODE_NUMBER))
export VERITY_BASIC_EVENT_STORE_PORT=$((VAS_BASIC_EVENT_STORE_PORT_BASE+CUR_NODE_NUMBER))
export VERITY_BASIC_CONSUMER_PORT=$((VAS_BASIC_EVENT_CONSUMER_PORT_BASE+CUR_NODE_NUMBER))
